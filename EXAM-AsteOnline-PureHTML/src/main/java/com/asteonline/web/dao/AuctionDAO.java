package com.asteonline.web.dao;
...
public class AuctionDAO {
     ...
     */
    public void newAuction(Date deadline, int minimumRise, int userID, String[] itemsCodes) throws SQLException {
    ...
    /**
     * This method returns all the open auctions created by a user.
     * @param userID the ID of the user
     */
    public List<Auction> openUserAuctions(int userID) throws SQLException {
        return userAuctions(userID, AuctionStatus.OPEN);
    }

    /**
     * This method returns all the closed auctions created by a user.
     * @param userID the ID of the user
     */
    public List<Auction> closedUserAuctions(int userID) throws SQLException {
        return userAuctions(userID, AuctionStatus.CLOSED);
    }

    /**
     * This method returns all the auctions created by a user.
     * @param userID the ID of the user
     */
    public List<Auction> userAuctions(int userID) throws SQLException {
        return userAuctions(userID, null);
    }

    /**
     * This method returns all the auctions created by a user.
     * @param userID the ID of the user
     * @param status filter the auctions by status, if null all the auctions are returned
     */
    public List<Auction> userAuctions(int userID, AuctionStatus status) throws SQLException {
