...
import com.asteonline.web.utils.Hash;
...
public class UserDAO {
	 ...
	 * @return the id of the user if the authentication is successful, -1 otherwise
	 */
	public int authenticateUser(String usernameOrEmail, String password) throws SQLException {
